...
curl -o ./entpassgen -s https://github.com/andreimerlescu/entpassgen/releases/download/v0.2.1/entpassgen.linux-amd64
chmod +x entpassgen
...
Invoke-WebRequest "https://github.com/andreimerlescu/entpassgen/releases/download/v0.2.1/entpassgen.windows-amd64.exe" -OutFile C:\bin\entpassgen.exe
entpassgen.exe -h
```
